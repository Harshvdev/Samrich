...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: post.title,
    description: post.excerpt || `A poem by Samrich.`,
    openGraph: {
    ...
    <>
      ...
      <main className="flex-1 py-16 sm:py-24 px-6">
        <article className="reader-container">
          ...
          {/* POEM BODY (Stanza Preservation) */}
          <div className="font-serif text-lg sm:text-xl text-[var(--paper-ink)] font-normal mb-16 py-4">
            {post.content_html ? (
              <div 
              ...
              <p className="italic text-[var(--paper-ink-muted)]">No poem lines recorded.</p>
            )}
          </div>
